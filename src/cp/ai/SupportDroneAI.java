...
public class SupportDroneAI extends AIController {
    //Original code is from NightScape(here -> https://github.com/SaigoN0Nozomi/nightscape/blob/master/src/nightscape/entity/ai/AdvancedDefenderAI.java)
    @Override
